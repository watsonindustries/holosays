...
<div class="py-10 px-10 sm:px-12 md:px-16 lg:px-24 xl:px-32">
    <article class="prose">
        ...
        <p>In the future, HoloSays will also make it easier for indie vtubers to generate subtitled content, timestamps and more.</p>
        ...
        <p><a href="https://openai.com/product/gpt-4" class="link link-primary">GPT</a> is one of the top Large Language Models (LLMs) available today, that allows us to perform novel tasks that previously required human input. This includes:
            <ul class="list-disc">
                <li>Content summaries</li>
                <li>Chapter generation</li>
                <li>Embeddings</li>
                <li>Natural language search across videos</li>
            </ul>
        ...
        <p>We will also explore translation of non-English streams, using tuned models developed by the community.</p>
        <h2>Questions?</h2>
